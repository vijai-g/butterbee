  ...
  return (
    <header className="sticky top-0 z-40 bg-white/70 backdrop-blur border-b border-black/5">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        {/* Desktop nav (no Cart/Checkout text links) */}
        <nav className="hidden md:flex items-center gap-2">
          ...
          <Link href="/cart" className="relative px-3 py-2" aria-label="View cart">
            ...
            {count > 0 && (
              <span className="absolute -right-1 -top-1 inline-flex h-5 min-w-[20px]
      ...
      {/* Mobile drawer (no Cart/Checkout text links) */}
      {mobileOpen && (
