...
export default function MenuPage(){
  ...
  useEffect(()=>{ setCategory((sp.get("category") as Category) || "All"); },[sp]);
  ...
  return (
    <div className="space-y-6">
      ...
      />
      {filtered.length === 0 && (<p className="text-gray-600">No items match your search. Try different filters.</p>)}
